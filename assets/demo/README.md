...
GitHub plays the mp4 in-browser when you open the file. For a watch-without-download path, use the YouTube slot below once the parent agent pastes the unlisted URL.
...
**Watch on YouTube:** *(link forthcoming — paste unlisted URL here)*
